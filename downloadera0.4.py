...
class baixar (): 
 ...
 def janela(self):
  ...
  self.progresse.place(x=63,y=155)

  

  avisos = Label(janela,text='Link do Vídeo')
  ...
  bot.place(x=100,y=80)

  bot= Button(janela,text="Baixa",command = lambda:self.start_teding()) 
  bot.place(x=20,y=80)

  label = ttk.Label( janela ,text="Resolução:")
  label.place(x=20,y=110)
  
  label = ttk.Label( janela ,text="Download:")
  label.place(x=0,y=155)
  ...
  self.month_cb.place(x=20,y=130)
  try:
